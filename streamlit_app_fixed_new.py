                ...
                <script>
                    ...
                    window.safeD3 = {{
                        ...
                        createAxesWithLabels: function(svgElement, xScale, yScale, options = {{}}) {{
                            ...
                            if (options.margin) {{
                                config.margin = Object.assign({{}}, defaults.margin, options.margin);
                            }}
                            ...
                            try {{
                                ...
                                return {{xAxisG, yAxisG, innerWidth, innerHeight}};
                            }} catch (e) {{
                                console.warn("Error creating axes with labels:", e);
                                // If there's an error, create minimal axes
                                const fallbackXScale = this.createLinearScale([0, 100], [0, 500]);
                                const fallbackYScale = this.createLinearScale([0, 100], [500, 0]);
                                ...
                                const xAxisG = g.append("g")
                                    ...
                                    .call(d3.axisBottom(fallbackXScale));
                                    
                                const yAxisG = g.append("g")
                                    .attr("class", "y-axis")
                                    .call(d3.axisLeft(fallbackYScale));
                                    
                                return {{xAxisG, yAxisG, innerWidth: 500, innerHeight: 500}};
                            }}
                        }}
                    }};
